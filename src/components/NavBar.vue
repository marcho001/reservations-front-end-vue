<template>
  ...
  >
    <div class="d-flex align-items-center">
      <router-link class="nav_brand" to="/home">
        S.W.
      </router-link>
    </div>
    <div class="nav_wrapper">
      <template v-if="!currentUser.role">
        <router-link class="nav_wrapper_link" to="/signin">
          登入
        </router-link>
        <router-link class="nav_wrapper_link" to="/join">
          加入我們
        </router-link>
      </template>
      <template v-else>
        ...
        <button class="nav_wrapper_link" @click="logout">登出</button>
      </template>
    </div>
  </nav>
</template>
